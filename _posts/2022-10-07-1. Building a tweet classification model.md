...
<br>
In a nutshell the goal of both of these techniques is to reduce a devirational word to a common base form. Lemmatization reduces a word to it root word also known as a lemma. Stemming also reduces a word to a smaller word, but it is not necessarily a meaningful word<br>
